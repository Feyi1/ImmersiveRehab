...
public class M_laser2_5 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        polePost = GameObject.Find("RCylinderInner5").transform.position;
        centerpost = GameObject.Find("leftCyl_inner5").transform.position;
