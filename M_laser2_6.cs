...
public class M_laser2_6 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        polePost = GameObject.Find("RCylinderInner6").transform.position;
        centerpost = GameObject.Find("leftCyl_inner6").transform.position;
