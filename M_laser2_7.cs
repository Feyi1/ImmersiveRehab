...
public class M_laser2_7 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        polePost = GameObject.Find("RCylinderInner7").transform.position;
        centerpost = GameObject.Find("leftCyl_inner7").transform.position;
