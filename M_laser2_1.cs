...
public class M_laser2_1 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        polePost = GameObject.Find("RCylinderInner1").transform.position;
        centerpost = GameObject.Find("leftCyl_inner1").transform.position;
